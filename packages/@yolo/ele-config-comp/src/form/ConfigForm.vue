...
import type { IFormConfig } from '@/form/types'

import { getCurrentInstance, defineModel } from 'vue'
import SubFormHeader from '@/form/components/SubFormHeader.vue'
import SubFormBody from '@/form/components/SubFormBody.vue'
...
const configFormRef = (configFormInstance: HTMLElement) => {
